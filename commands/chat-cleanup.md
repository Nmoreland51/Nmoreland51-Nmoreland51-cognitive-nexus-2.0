---
description: Use this command for conversation handling and response shaping when you need to reduce clutter and simplify the current state.
---

# Chat Cleanup

Use this command to reduce clutter and simplify the current state.
