---
description: Use this command for conversation handling and response shaping when you need to make the core change for the requested outcome.
---

# Chat Implement

Use this command to make the core change for the requested outcome.
