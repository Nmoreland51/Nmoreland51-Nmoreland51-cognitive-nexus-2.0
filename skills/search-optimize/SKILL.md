...
description: Use when work involves web search routing, retrieval, and source-aware answering and you need to optimize the area without losing reliability.
---
